...
export const parseInspectionSource = (
  source: string | null,
): InspectionSource | undefined => {
  return source === InspectionSource.DocMind
    ? InspectionSource.DocMind
    : undefined;
};

export const useInspectionSource = () => {
  const [currentQueryParameters] = useSearchParams();

  return parseInspectionSource(currentQueryParameters.get('source'));
};
