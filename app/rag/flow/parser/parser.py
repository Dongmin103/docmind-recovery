    ...
    def _pdf(self, name, blob, **kwargs):
        ...
        if parse_method.lower() == "deepdoc":
            ...
            if conf.get("enable_multi_column"):
                ...
                # Previews are rendered later from the source PDF. Keeping all
                # rasterized parser pages alive through title chunking can
                # exhaust memory on long multi-column documents.
                pdf_parser.page_images.clear()
