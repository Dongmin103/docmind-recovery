...
def make_raptor_summary_chunk_id(content: str, doc_id: str, *, summary_ordinal=None, layer_ordinal=None, source_chunk_ids=None) -> str:
    ...
    return make_chunk_id(
        "raptor_summary",
        doc_id,
        source_chunk_uid=source_chunk_ids,
        chunk_order_int=summary_ordinal,
