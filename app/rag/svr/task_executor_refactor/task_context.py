...
class TaskDict(TypedDict, total=False):
    ...
    parse_run_id: str
    """Parser-platform run identifier."""

    chunk_set_id: str
    """Run-scoped staging chunk-set identifier."""
...
class TaskContext:
    ...
    @property
    def parse_run_id(self) -> str:
        """Parser-platform run identifier, empty for legacy tasks."""
        return self._task.get("parse_run_id", self._DEFAULTS["parse_run_id"]) or ""

    @property
    def chunk_set_id(self) -> str:
        """Run-scoped staging chunk-set identifier, empty for legacy tasks."""
        return self._task.get("chunk_set_id", self._DEFAULTS["chunk_set_id"]) or ""
