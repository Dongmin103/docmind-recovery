...
> **DocMind CPU canary:** see [DOCMIND.md](./DOCMIND.md). This public candidate
> targets an internal-network `linux/amd64` deployment with serial Surya 2 CPU
> parsing and one real PDF only.
